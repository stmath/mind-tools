...
var Packer = function Packer(direction, w, h) {
...
Packer.prototype = {
	...
	init: function init(direction, w, h) {
	...
	fit: function fit(blocks) {
		switch (this.direction) {
			case Packer.HORIZONTAL:
				this.fitHorizontal(blocks);break;
			case Packer.VERTICAL:
				this.fitVertical(blocks);break;
		}
	},

	fitHorizontal: function fitHorizontal(blocks) {
		var self = this;
		this.width = 0;
		this.height = 0;
		var x = 0;
	...
	fitVertical: function fitVertical(blocks) {
		var self = this;
		this.width = 0;
		this.height = 0;
		var x = 0;
